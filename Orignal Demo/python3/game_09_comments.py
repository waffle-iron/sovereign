...
def guard():
    ...
    #       the function was called from, in this case, blissful_ignorance_of_illusion_room()
    #       Since there's nothing else to do in blissful_ignorance_of_illusion_room() after
